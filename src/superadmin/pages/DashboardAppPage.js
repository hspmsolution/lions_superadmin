    ...
    <>
      ...
      <Grid container spacing={2}>
        <Grid item xs={12} sm={6}>
          <StatsTable
            data={stats?.activityTypeCount}
            type={"Activity Type Stats"}
          />
        </Grid>
        <Grid item xs={12} sm={6}>
          <StatsTable
            data={stats?.activitySubTypeCount}
            type={"Activity Sub-Type Stats"}
          />
        </Grid>
        <Grid item xs={12} sm={6}>
          <StatsTable
            data={stats?.activityCategoryCount}
            type={"Activity Category Stats"}
          />
        </Grid>
      </Grid>
      <UpComingActivity />
