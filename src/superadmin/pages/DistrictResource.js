...
import {
  addDistrictResources,
  deleteDistrictResources,
...
export default function DistrictResource() {
  const classes = useStyles();
  const fileUploadRef = useRef();
  const dispatch = useDispatch();
  const [deleteId, setDeleteId] = useState(null);
  const resources = useSelector((state) => state.assets.districtResources);
  ...
  const handleSubmit = (event) => {
    ...
    formData.append("title", districtResources.title);
    formData.append("image", districtResources.image.data);
    dispatch(addDistrictResources(formData));
    setDistrictResources({ title: "", image: { preview: "", data: "" } });
  };
  const handleFileRead = async (event) => {
    ...
    setDistrictResources({ ...districtResources, image: img });
  };
    ...
    <>
          ...
          >
            ...
            >
              ...
              <Box>
                ...
                />
                {districtResources.image.preview && (
                  <img
                    src={districtResources.image.preview}
                    width="100"
                    height="100"
                    alt="gallery"
                  />
      ...
      >
        ...
        <DialogActions>
          ...
          <Button
            onClick={() => {
              dispatch(deleteDistrictResources(deleteId));
              handleCloseDel();
            }}
            autoFocus
            color="error"
