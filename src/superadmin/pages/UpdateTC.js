...
const UpdateTC = () => {
  ...
  return (
    ...
    color: "#003895",alignItems:'center',margin:'1em'}}>Add Terms and Conditions</Typography>
        <ReactQuill
  ...
  <Typography variant="h6" gutterBottom sx={{ width: "25%",
    borderBottom: "2px solid #B4880B",
    color: "#003895",alignItems:'center',margin:'1em'}}>Terms and Conditions</Typography>
